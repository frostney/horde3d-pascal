...
{$ELSE}
  {$IFDEF darwin}
    OPENGL_LIBNAME = '/System/Library/Frameworks/OpenGL.framework/Versions/A/Libraries/libGL.dylib';
    GLU_LIBNAME = '/System/Library/Frameworks/OpenGL.framework/Versions/A/Libraries/libGLU.dylib';
  {$ELSE}
